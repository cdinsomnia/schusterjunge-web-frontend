      ...
      <div className="flex flex-col text-end">
        <div className="leading-6 flex flex-col gap-4 bg-['']">
          ...
          <div className="text-shadow-white">
            <p>Ausproduzierte Musik von ein & der selben Person war noch nie so preiswert.</p>
            <p>Vor Ort spiele ich alle meine aktuellen ausproduzierten Tracks, welche zusammen den Schusterjunge-Effekt ergeben.</p>
            <p>Die Formel für gute, ausbalancierte Musik welche Hörer und Veranstalter gleichermaßen in den Bann zieht.</p>
          </div>
        </div>
      </div>
    </section>
